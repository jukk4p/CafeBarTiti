...
export const MENU_BACKUP: Record<string, MenuSection> = {
  ...
  "Postres o Helados": {
    items: [
      ...
      { id: "copa-helado", nombre: "Copa de Helado Variado", desc: "Tres bolas de helado a elegir: Vainilla, Chocolate o Fresa.", prices: { racion: 3.50 }, alergenos: ["Lácteos"], image: "/menu/helado.webp" },
      ...
      { id: "flan-huevo", nombre: "Flan de Huevo Casero", desc: "Receta tradicional con caramelo artesano.", prices: { racion: 3.00 }, alergenos: ["Huevos", "Lácteos"], image: "/menu/flan.webp" },
